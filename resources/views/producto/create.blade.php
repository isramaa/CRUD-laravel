...
{{--            <button href="{{ route('productos.index') }}" class="btn btn-succes" id="btn-return">Lista de productos</button>
 --}}       </form>
   </div>

    <div class="row mt-3">
        <a href="{{ route('productos.index') }}" class="btn btn-succes" id="btn-return">Lista de productos</a>
    </div>
