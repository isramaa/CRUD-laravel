...
<hr>
<div class="row">
       <form action="{{ route('pedidos.update', $pedido->id) }}" method="post" enctype="multipart/form-data" class="col-lg-7">
           ...
           <button href="{{ route('pedidos.index') }}" class="btn btn-primary" id="btn-return">Lista de Pedidos</button>
       </form>

       {{-- <div class="row mt-3">
        <a href="{{ route('pedidos.index') }}" class="btn btn-primary" id="btn-return">Lista de Pedidos</a>
    </div> --}}
   </div>
</div>
@endsection